...
export function ProductCard({
  ...
  // Build the product URL using link_rewrite if available
  const productUrl = href || (linkRewrite ? `/producto/${linkRewrite}-${id}` : `/producto/${id}`)
        ...
        <CardContent className="p-3 sm:p-4 flex flex-col h-full">
          <div className="relative mb-3 sm:mb-4">
            ...
            {isPrescriptionRequired && (
                ...
                >
                  <span className="hidden sm:inline">Requiere receta</span>
          ...
          <div className="flex-1 flex flex-col">
            ...
            >
              {isInStock ? (
                  ...
                  <span className="text-xs sm:text-sm">Agotado</span>
              )}
            </Button>
          </div>
        </CardContent>
