...
import { EnhancedProductGrid } from "@/components/ui/enhanced-product-grid"

export default function FilteredProductListingPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span className="text-gray-900">Products with Advanced Filters</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center">
            <h1 className="text-3xl font-bold mb-4">Advanced Product Search</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Use our advanced filtering system to find exactly what you need. Filter by price, brand, category,
              ratings, and more to discover the perfect healthcare products for your needs.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto">
        <Suspense fallback={<EnhancedProductGrid loading={true} />}>
          <EnhancedProductGrid />
        </Suspense>
      </div>
